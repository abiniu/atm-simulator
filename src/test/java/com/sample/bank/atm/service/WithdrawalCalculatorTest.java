...
class WithdrawalCalculatorTest {
	...
	void testForZero() {
		...
		assertThat(calculateSplit.getWithdrawAmount()).isEqualTo(0l);
	...
	void testForAmmount(Withdrawal ammount) {
		Withdrawal calculateSplit = withdrawalCalculator.calculateSplit(ammount.get_50Note(), ammount.get_20Note(),
				ammount.get_10Note(), ammount.get_5Note(), ammount.getWithdrawAmount());
		assertThat(calculateSplit.getWithdrawAmount()).isEqualTo(ammount.getWithdrawAmount());
	...
	void testForAmmount() {
		...
		assertThat(calculateSplit.getWithdrawAmount()).isEqualTo(60l);
		...
		assertThat(calculateSplit.getWithdrawAmount()).isEqualTo(200l);
		...
		assertThat(calculateSplit.getWithdrawAmount()).isEqualTo(235l);
